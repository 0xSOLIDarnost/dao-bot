...
require (
	github.com/0xSOLIDarnost/MultisigLegacy v0.0.4
	github.com/MoonSHRD/IKY-telegram-bot v0.0.13
...
require (
	github.com/ChronosX88/go-throttle v0.0.0-20211224215823-669e7daa5ced
